<?php /*a:3:{s:75:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\attr\add_edit.html";i:1571020665;s:75:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\layout\header.html";i:1570606922;s:75:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\layout\footer.html";i:1570864758;}*/ ?>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="userEdit" id="userEdit" method="post"
                          action="<?php echo !empty($data) ? '/admin/attr/update' : 'save'; ?>">
                        ...
                        <option value="<?php echo htmlentities($v['id']); ?>" <?php echo !empty($data) ? ($data['cate_id']==$v['id']?'selected' : ''):''; ?>><?php echo htmlentities($v['p_title']); ?>--<?php echo htmlentities($v['title']); ?></option>
                        <?php endforeach; ?>
                        </select>
                        </div>
                        </div>
