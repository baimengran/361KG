<?php /*a:3:{s:79:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\category\add_edit.html";i:1569174167;s:75:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\layout\header.html";i:1570606922;s:75:"D:\phpstudy_pro\WWW\www.361kg.com\application\admin\view\layout\footer.html";i:1570864758;}*/ ?>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5><?php echo !empty($data) ? '编辑栏目' : '新增栏目'; ?></h5>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="userEdit" id="userEdit" method="post"
                          action="<?php echo !empty($data) ? '/admin/category/update' : 'save'; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="hidden" id="data_photo" name="icon" value="<?php echo !empty($data) ? htmlentities($data['icon']) : ''; ?>"/>
                                ...
                                <img id="img_data" height="100px" width="100px"
                                     ...
                                     src="<?php echo !empty($data) ? htmlentities($data['icon']) : ''; ?>" onerror="this.src='/static/admin/img/no_img.jpg'"/>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
